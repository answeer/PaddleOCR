...
if __name__ == "__main__":
    ...
    BASE_FOLDER = r"CLM_new\All"

    OUTPUT_FOLDER = r"clause_new_2"
    META_OUTPUT_FOLDER = r"metadata_new_2"

    OUTPUT_CSV_PATH = r"clauses_pages_only.csv"
    
    USER_PROMPT = "LLM_prompt.txt"
    CLAUSE_DETAILS = "general_specific_clause_combined.json"

    extractor = ContractMetadataExtractor(
        base_folder=BASE_FOLDER,
        user_prompt_path=USER_PROMPT,
        clause_details_path = CLAUSE_DETAILS,
    ...
    json_to_csv_prepend_new(OUTPUT_FOLDER, OUTPUT_CSV_PATH)
